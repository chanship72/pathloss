...
def makeXforGraph(X, Y, category):
    # addData[['logDistance', 'logFrequency', 'logHeightB', 'logHeightM', 'logHeightTratio']]
    ...
    for df in groupDF:
        ...
        convertedX.append(tmpDF[['logDistance', 'logFrequency', 'logHeightB', 'logHeightM', 'logHeightTratio']])
